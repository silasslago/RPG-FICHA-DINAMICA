...
public class API {
	...
	static String title = "Mesa de RPG";
	public static int current = 1;
	public static String slot = "Slot " + current;
	
	public static void main(String[] args) throws JSONException {
	   
		String gameCode = "39ad5357f3", pageText,
		slots[];
	...
	//O método gera um novo documento com um novo código na URL para ser usado na mesa
	...
	public static void updatePage(String gameCode, String save) throws JSONException {
		//Estruturar o texto da página para modificar somente uma linha
